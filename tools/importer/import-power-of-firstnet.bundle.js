var CustomImportScript = (() => {
  ...
  // tools/importer/import-power-of-firstnet.js
  var import_power_of_firstnet_exports = {};
  __export(import_power_of_firstnet_exports, {
    default: () => import_power_of_firstnet_default
  });
  ...
  function parse3(element, { document, html }) {
    const cells = [];
  ...
  var import_power_of_firstnet_default = {
    /**
  ...
  return __toCommonJS(import_power_of_firstnet_exports);
})();
